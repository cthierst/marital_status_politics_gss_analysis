...
This paper uses the R statistical programming language [@citeR], along with several packages, tidyverse [@citetidyverse], janitor [@citejanitor], here [@citehere], and [@citedplyr]. All figures in this paper were created using the packages ggplot2 [@citeggplot2] and the tables were created using knitr [@citeknitr] and kableExtra[@citekablextra]. The color styling of graphs has been created using RColorBrewer [@citecolorbrewer]. The model in this paper was created using the rstanarm [@citerstanarm] package.
